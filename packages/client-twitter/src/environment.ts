...
export async function validateTwitterConfig(
    ...
    console.log('runtime.character.xConfig', runtime.character.xConfig);
    console.log("========================");
    try {
        const twitterConfig = {
            TWITTER_DRY_RUN:
            ...
            TWITTER_USERNAME:
                runtime.character.xConfig.username ||
                process.env.TWITTER_USERNAME,

            TWITTER_PASSWORD:
                runtime.character.xConfig.password ||
                process.env.TWITTER_PASSWORD,

            TWITTER_EMAIL: 
              runtime.character.xConfig.email || process.env.TWITTER_EMAIL,
            ...
            ENABLE_TWITTER_POST_GENERATION: 
              runtime.character.xConfig.generate || true,

            // int in minutes
            POST_INTERVAL_MIN: 
              runtime.character.xConfig.interval || 90,

            // int in minutes
            POST_INTERVAL_MAX: 
              runtime.character.xConfig.interval || 180,
